...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
   <link rel="stylesheet" href="http://localhost:8080/paginaUsuario/css/style.css" charset="UTF-8">
  <title>Sobre</title>
</head>
<body>
 ...
 <div class="container">
     <h1 style="color: white">CSloution - Cursos Online</h1>
 ...
 <body-item>
     <div class="container-caixa">
         <div class="caixa">
             <img alt="description of the image" height="300" src="img.icon/CSolution%20Digital%20Courses%20Logo.gif"
                  width="600">
         </div>
     </div>
 </body-item>
